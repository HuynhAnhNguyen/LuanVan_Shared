...
namespace LuanVan.Areas.AdminManage.Pages.Payment
{
    ...
    public class ExportPaymentPdfModel : PaymentPageModel
    {
        public ExportPaymentPdfModel(ApplicationDbContext context, INotyfService notyf, ILogger<PaymentPageModel> logger, LanguageService localization) : base(context, notyf, logger, localization)
        {
        }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            string htmlString = "<!DOCTYPE html>" +
                ...
                "<body>" +
                "<h1 style=\"text-align: center;text-transform: uppercase;font-weight: bold;\">" + _localization.Getkey("DSPTTT") + "</h1>" +
                ...
                "<th>" + _localization.Getkey("DSPTTTMa") + "</th>" +
                "<th>" + _localization.Getkey("DSPTTTTen") + "</th>" +
                "</tr></thead>" +
                "<tbody>";
            ...
            foreach (var item in listData)
            {
                ...
                htmlString += "<td>" + item.TenPTTT + "</td></tr>";
                stt++;
            }

            htmlString += "</tbody></table></div></body></html>";

            string filename = "DSPTTT_" + DateTimeVN().Ticks + ".pdf";
