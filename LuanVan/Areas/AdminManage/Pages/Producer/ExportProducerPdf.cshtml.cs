...
namespace LuanVan.Areas.AdminManage.Pages.Producer
{
    ...
    public class ExportProducerPdfModel : ColorPageModel
    {
        public ExportProducerPdfModel(ApplicationDbContext context, INotyfService notyf, ILogger<ColorPageModel> logger, LanguageService localization) : base(context, notyf, logger, localization)
        {
        }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            string htmlString = "<!DOCTYPE html>" +
                ...
                "<body>" +
                "<h1 style=\"text-align: center;text-transform: uppercase;font-weight: bold;\">" + _localization.Getkey("DSProducer") + "</h1>" +
                ...
                "<th>" + _localization.Getkey("DSProducerMa") + "</th>" +
                "<th>" + _localization.Getkey("DSProducerName") + "</th>" +
                "</tr></thead>" +
                "<tbody>";
            ...
            foreach (var item in listData)
            {
                ...
                htmlString += "<td>" + item.TenNSX + "</td></tr>";
                stt++;
            }
            ...
            string filename = "DSNSX_" + DateTimeVN().Ticks + ".pdf";
