...
namespace LuanVan.Areas.AdminManage.Pages.Home
{
    ...
    public class RevenueByQuarterPdfModel : HomePageModel
    {
        public RevenueByQuarterPdfModel(ApplicationDbContext context, IWebHostEnvironment webHostEnvironment, LanguageService localization) : base(context, webHostEnvironment, localization)
        {
        }
        ...
        public IActionResult OnPost()
        {
            ...
            string htmlString = "<!DOCTYPE html>" +
                ...
                "<body>" +
                "<h1 style=\"text-align: center;text-transform: uppercase;font-weight: bold;\">" + _localization.Getkey("DTByQuy") + "</h1>" +
                ...
                "<th>" + _localization.Getkey("Quy") + "</th>" +
                "<th>" + _localization.Getkey("Year") + "</th>" +
            ...
            string filename = "DoanhThuTheoQuy_" + DateTimeVN().Ticks + ".pdf";
