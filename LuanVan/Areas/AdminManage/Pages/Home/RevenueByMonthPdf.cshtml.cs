...
namespace LuanVan.Areas.AdminManage.Pages.Home
{
    ...
    public class RevenueByMonthPdfModel : HomePageModel
    {
        public RevenueByMonthPdfModel(ApplicationDbContext context, IWebHostEnvironment webHostEnvironment, LanguageService localization) : base(context, webHostEnvironment, localization)
        {
        }
        ...
        public IActionResult OnPost()
        {
            ...
            string htmlString = "<!DOCTYPE html>" +
                ...
                "<body>" +
                "<h1 style=\"text-align: center;text-transform: uppercase;font-weight: bold;\">" + _localization.Getkey("DTByMonth") + "</h1>" +
            ...
            string filename = "DoanhThuTheoThang_" + DateTimeVN().Ticks + ".pdf";
