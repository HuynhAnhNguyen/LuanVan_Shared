...
namespace LuanVan.Areas.AdminManage.Pages.Home
{
    ...
    public class RevenueByWeekExcelModel : HomePageModel
    {
        public RevenueByWeekExcelModel(ApplicationDbContext context, IWebHostEnvironment webHostEnvironment, LanguageService localization) : base(context, webHostEnvironment, localization)
        {
        }
        ...
        public IActionResult OnPost()
        {
            ...
            string filename = "DoanhThuTheoTuan_" + DateTimeVN().Ticks + ".xlsx";
