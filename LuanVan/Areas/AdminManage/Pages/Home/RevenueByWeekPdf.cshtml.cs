...
namespace LuanVan.Areas.AdminManage.Pages.Home
{
    ...
    public class RevenueByWeekPdfModel : HomePageModel
    {
        public RevenueByWeekPdfModel(ApplicationDbContext context, IWebHostEnvironment webHostEnvironment, LanguageService localization) : base(context, webHostEnvironment, localization)
        {
        }
        ...
        public IActionResult OnPost()
        {
            ...
            string htmlString = "<!DOCTYPE html>" +
                ...
                "<body>" +
                "<h1 style=\"text-align: center;text-transform: uppercase;font-weight: bold;\">" + _localization.Getkey("DTByWeek") + "</h1>" +
                ...
                "<th>" + _localization.Getkey("Week") + "</th>" +
            ...
            string filename = "DoanhThuTheoTuan_" + DateTimeVN().Ticks + ".pdf";
