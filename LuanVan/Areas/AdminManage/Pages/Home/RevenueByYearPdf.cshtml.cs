...
namespace LuanVan.Areas.AdminManage.Pages.Home
{
    ...
    public class RevenueByYearPdfModel : HomePageModel
    {
        public RevenueByYearPdfModel(ApplicationDbContext context, IWebHostEnvironment webHostEnvironment, LanguageService localization) : base(context, webHostEnvironment, localization)
        {
        }
        ...
        public IActionResult OnPost()
        {
            ...
            string htmlString = "<!DOCTYPE html>" +
                ...
                "<body>" +
                "<h1 style=\"text-align: center;text-transform: uppercase;font-weight: bold;\">" + _localization.Getkey("DTByYear") + "</h1>" +
            ...
            string filename = "DoanhThuTheoNam_" + DateTimeVN().Ticks + ".pdf";
