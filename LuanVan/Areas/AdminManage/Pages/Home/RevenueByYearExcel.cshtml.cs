...
namespace LuanVan.Areas.AdminManage.Pages.Home
{
    ...
    public class RevenueByYearExcelModel : HomePageModel
    {
        public RevenueByYearExcelModel(ApplicationDbContext context, IWebHostEnvironment webHostEnvironment, LanguageService localization) : base(context, webHostEnvironment, localization)
        {
        }
        ...
        public IActionResult OnPost()
        {
            ...
            string filename = "DoanhThuTheoNam_" + DateTimeVN().Ticks + ".xlsx";
